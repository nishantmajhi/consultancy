function filterAndRenderTable(query) {
    ...
    const filteredJobs = query ? jobs.filter((job) =>
      ...
      row.innerHTML = `
        ...
        <td>
          <div class="action_buttons">
            <button class="green_button transparent_button" title="Relist Job" onclick="reListDialog('${job.id}')">Relist</button>
            <button class="red_button transparent_button" title="Delete Job" onclick="removeDialog('${job.id}')">Delete</button>
          </div>
        </td>
      `;
