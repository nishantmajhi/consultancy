<?php
    ...
    $headerContents = UI::getHeaderContents("Old Clients");
    
    $htmlContent = str_replace(['{{COMPANY_NAME}}', '{{ASIDE_CONTENTS}}', '{{HEADER_CONTENTS}}'], [$companyName, $asideContents, $headerContents], file_get_contents('archivedClients.html'));
