<?php
    ...
    $headerContents = UI::getHeaderContents("List Clients");
    
    $htmlContent = str_replace(['{{COMPANY_NAME}}', '{{ASIDE_CONTENTS}}', '{{HEADER_CONTENTS}}'], [$companyName, $asideContents, $headerContents], file_get_contents('listClients.html'));
