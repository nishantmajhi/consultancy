<?php
    ...
    $headerContents = UI::getHeaderContents("Add Client");
    
    $htmlContent = str_replace(['{{COMPANY_NAME}}', '{{ASIDE_CONTENTS}}', '{{HEADER_CONTENTS}}'], [$companyName, $asideContents, $headerContents], file_get_contents('addClient.html'));
